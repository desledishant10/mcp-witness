...
class AnthropicAgent:
    ...
    - `MCPSCAN_AGENT_MODEL` (default: `claude-opus-4-7`)
    - `MCPSCAN_AGENT_MAX_ITERATIONS` (default: 10)
    ...
    def __init__(self, model: str | None = None, max_iterations: int | None = None) -> None:
        ...
        self.model = model or os.environ.get("MCPSCAN_AGENT_MODEL", "claude-opus-4-7")
        self.max_iterations = max_iterations or int(
            os.environ.get("MCPSCAN_AGENT_MAX_ITERATIONS", "10"),
        )
