---
title: "I found an SSRF in Anthropic's reference MCP server, proved it on EC2, and the verified fix is still unmerged"
description: "A coordinated disclosure of outbound SSRF in mcp-server-fetch: proven on EC2 with live IAM credentials, a community fix verified twice, and four months later still unmerged while vulnerable releases keep shipping."
---
