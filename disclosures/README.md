...
|---|---|---|---|---|
| 2026-05-12 | `mcp-server-fetch` v2025.4.7 | Public GitHub issue [modelcontextprotocol/servers#4143](https://github.com/modelcontextprotocol/servers/issues/4143) | ⚠️ **Community fix PR open + branch-verified; maintainer merge pending 30 days** — community contributor `@kgarg2468` opened fix PR [#4226](https://github.com/modelcontextprotocol/servers/pull/4226) on 2026-05-22 with scheme allowlist + RFC-reserved-range denylist + per-redirect validation. Branch verified against the EC2 demo (2026-05-22) and against the containerized [`poc/ssrf/`](../poc/ssrf/) harness (2026-06-20); both refuse with *"Fetching private or non-public IP addresses is not allowed"*. **PR still open + unmerged as of 2026-06-20; latest PyPI release `mcp-server-fetch==2026.6.4` (uploaded 2026-06-04) still vulnerable** | (issue thread + [finding entry](../findings/2026-05-11-MCP-D-003-fetch-direct-environment-dependent-ssrf.md)) |
